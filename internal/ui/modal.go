...
func (m *HelpModal) View() string {
	...
	lines = append(lines, m.renderKeybind("global.cycle_focus", "Cycle Panes"))
	...
	lines = append(lines, m.renderKeybind("explorer.toggle_columns", "Toggle Columns"))
	...
	lines = append(lines, m.renderKeybind("grid.delete_row", "Delete Row"))
	lines = append(lines, m.renderKeybind("grid.insert_row", "Insert Row"))
	lines = append(lines, m.renderKeybind("grid.yank", "Yank (Copy)"))
